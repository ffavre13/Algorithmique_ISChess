...
def get_move_king(y,x,board):
    ...
    return possible_positions, possible_eat
...
def get_all_possible_moves(player_sequence, board):
        ...
        for j in range(len(board[0])):
            if board[i][j] != '':
                if board[i][j][1] == current_player:
                    match board[i][j][0]:
                        case "k":
                            position, position_eat = get_move_king(i,j,board)
                            if len(position_eat) != 0:
                                for miam in position_eat:
                                    moves_eat.append(((i, j), miam))
                            else:
                                for pos in position:
                                    moves.append(((i, j), pos))
                        case "q":
                            position, position_eat = get_move_queen(i,j,board)
                            if len(position_eat) != 0:
                                for miam in position_eat:
                                    moves_eat.append(((i, j), miam))
                            else:
                                for pos in position:
                                    moves.append(((i, j), pos))
                        case "n":
                            position, position_eat = get_move_knight(i,j,board)
                            if len(position_eat) != 0:
                                for miam in position_eat:
                                    moves_eat.append(((i, j), miam))
                            else:
                                for pos in position:
                                    moves.append(((i, j), pos))
                        case "b":
                            position, position_eat = get_move_bishop(i,j,board)
                            if len(position_eat) != 0:
                                for miam in position_eat:
                                    moves_eat.append(((i, j), miam))
                            else:
                                for pos in position:
                                    moves.append(((i, j), pos))
                        case "r":
                            position, position_eat = get_move_rook(i,j,board)
                            if len(position_eat) != 0:
                                for miam in position_eat:
                                    moves_eat.append(((i, j), miam))
                            else:
                                for pos in position:
                                    moves.append(((i, j), pos))
                        case "p":
                            position, position_eat = get_move_pawn(i,j,board)
                            if len(position_eat) != 0:
                                for miam in position_eat:
                                    moves_eat.append(((i, j), miam))
                            else:
    ...
    return moves, moves_eat

def chess_bot(player_sequence, board, time_budget, **kwargs):
    start_time = time.time()
    moves, moves_eat = get_all_possible_moves(player_sequence, board)
    if len(moves_eat) != 0:
        current_best_move = moves_eat[random.randint(0,len(moves_eat)-1)]
...
register_chess_bot("RodFav_Random_Eater", chess_bot)